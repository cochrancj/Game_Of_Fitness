...
![Landing Page](https://github.com/cochrancj/Game_Of_Fitness/blob/master/GoF-page1.pdf "Landing Page Wireframe")

![Character Creation Page](https://github.com/cochrancj/Game_Of_Fitness/blob/master/GoF-page2.pdf "Character Creation Page Wireframe")

![Profile Page](https://github.com/cochrancj/Game_Of_Fitness/blob/master/GoF-profile.pdf "Profile Page Wireframe")

![Workout Of The Day Page](https://github.com/cochrancj/Game_Of_Fitness/blob/master/GoF-wod.pdf "WOD Wireframe")
...
2. Navigate to the main page of the repo and click **Clone or download**
